...
cache=c()
routecache=c()
if(file.exists("../xlsx/distancia-min-enderecos.xlsx"))
{
rota=select(data.table(read.xlsx("../xlsx/distancia-min-enderecos.xlsx",1)),-NA.)
kms=c(rota$km)
...
write.xlsx(sprint,paste0("xlsx/distancia-min-pedidos-resumido-",today,".xlsx"),append=stat)
